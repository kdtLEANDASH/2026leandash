  ...
  const NoticeItem = ({ notice }) => (
    ...
    >
      <CardContent className="p-5">
        ...
        <div className={cn("flex items-center justify-between text-sm", textMuted)}>
            ...
            <CardContent className="p-6">
              ...
              >
                <div className={cn("flex gap-4 text-sm", textSub)}>
                  <button
                    className={isDark ? "hover:text-white" : "hover:text-blue-600"}
                  >
                    ▲ 작성 글
                  </button>
            ...
            {pinnedNotices.length > 0 && (
              <div className="mb-6">
                <div className="flex items-center gap-2 mb-3">
                  <Pin className="size-5 text-red-500" />
                  <h3 className={cn("font-semibold", textMain)}>고정 공지</h3>
                </div>
