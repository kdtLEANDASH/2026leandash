      ...
      <Card className={cn(darkCardClass)}>
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            ...
            <span className={cn("text-sm font-normal", isDark ? "text-zinc-300" : "text-gray-600")}>
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                      <div className="flex-1">
                        <div className="flex items-center flex-wrap gap-2 mb-2">
                          ...
                          <span className={cn("text-sm", isDark ? "text-zinc-300" : "text-gray-600")}>
                            {vacation.employeeName}
                          </span>
                        </div>

                        <div className={cn("text-sm mb-1", isDark ? "text-zinc-300" : "text-gray-600")}>
                          {vacation.startDate} ~ {vacation.endDate} (
                          {vacation.days}일)
                        </div>

                        <div className={cn("text-sm mb-1", isDark ? "text-zinc-200" : "text-gray-700")}>
                          사유: {vacation.reason}
                        </div>
