      ...
      >
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
            <div className={cn("rounded-lg border p-4", darkInnerBoxClass)}>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_360px] gap-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          {recommendedVacations.length === 0 ? (
            <Card className={cn("lg:col-span-2", darkCardClass)}>
              ...
              <Card
                ...
                className={cn(
                  ...
                  previewRecommendation?.id === recommendation.id &&
                    (isDark ? "ring-2 ring-[#8b8b96]" : "ring-2 ring-blue-500")
                )}
        ...
        <Card className={cn("h-fit", darkCardClass)}>
          <CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            {previewRecommendation ? (
              ...
              <div
                className={cn(
                  "rounded-lg border p-3 text-sm text-gray-500",
                  darkSubBoxClass
                )}
              >
            ...
            <div className="space-y-2">
              ...
              {previewDateData.events.map((event) => (
                <div
                  key={event.id}
                  className={cn("p-3 border rounded-lg text-sm", darkCardClass)}
                >
                  {event.title}
                </div>
              ))}
