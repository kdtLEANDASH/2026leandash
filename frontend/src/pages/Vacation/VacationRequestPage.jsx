...
export default function VacationRequestPage() {
  ...
  const periodBoxClass = isDark
    ? "h-10 flex items-center px-3 border rounded-md bg-[#2f2f36] border-[#5c5c73]"
    : "h-10 flex items-center px-3 border border-gray-300 rounded-md bg-gray-50";
