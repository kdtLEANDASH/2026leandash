...
export function ChatWidget() {
  ...
  const handleFileChange = (e) => {
    ...
    sendChatMessage(selectedRoom, fileMessage);
  ...
  if (!isOpen) {
    return (
      <Button
        ...
        className={cn(
          "fixed bottom-6 right-6 size-14 rounded-full shadow-lg text-white z-50",
          isDark
            ? "bg-[#5c5c73] hover:bg-[#4f4f64]"
  ...
  return (
    <div
      className={cn(
        "fixed bottom-6 right-6 rounded-lg shadow-2xl border z-50 flex flex-col overflow-hidden transition-all",
    ...
    >
      <div
        className={cn(
          "flex items-center justify-between p-4 border-b text-white rounded-t-lg shrink-0",
          isDark
        ...
        <div className="relative flex items-center gap-2 min-w-0">
          ...
          {isGroupRoom && (
            <button
              ...
              className="shrink-0 rounded-full bg-white/20 px-2 py-0.5 text-xs text-white hover:bg-white/30"
            >
          ...
          {isGroupRoom && showParticipants && (
            <div
              className={cn(
                "absolute left-0 top-9 z-[60] w-64 rounded-lg border p-2 shadow-xl",
                isDark
              ...
              <ScrollArea className="flex-1 min-h-0">
                <div className="p-2 space-y-1">
                  {filteredRooms.map((room) => (
                    ...
                    >
                      <div className="relative">
                        <div className="size-12 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center text-2xl text-white">
                          {room.avatar}
                        </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="relative">
                    ...
                    {showEmojiPicker && (
                      <div
                        className={cn(
                          "absolute bottom-full left-0 mb-2 z-50 w-64 rounded-xl border p-3 shadow-xl",
                          isDark
                            ? "border-[#5c5c73] bg-[#35353d]"
